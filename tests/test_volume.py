...
class MyTestCase(unittest.TestCase):
    ...
    def test_molecular_volume(self) -> None:
        ...
        assert_allclose(lipf6_volume_1, 47.62)
        assert_allclose(lipf6_volume_2, 43.36)
        assert_allclose(lipf6_volume_3, 41.49)
        assert_allclose(lipf6_volume_4, 51.94)
        assert_allclose(lipf6_volume_5, 79.08)
        ...
        assert_allclose(ec_volume_1, 38.44)
        assert_allclose(ec_volume_2, 43.17)
        assert_allclose(ec_volume_3, 40.95)
        assert_allclose(ec_volume_4, 41.07)
        assert_allclose(ec_volume_5, 38.44)
        assert_allclose(ec_volume_6, 63.83)
        ...
        assert_allclose(litfsi_volume_1, 100.16)
        assert_allclose(litfsi_volume_2, 100.16)
        assert_allclose(litfsi_volume_3, 99.37)
        assert_allclose(litfsi_volume_4, 90.78)
        assert_allclose(litfsi_volume_5, 105.31)
        assert_allclose(litfsi_volume_6, 166.32)
        assert_allclose(litfsi_volume_7, 124.66)
